...
/*! jquery extensions by Allex Wang (allex.wxn@gmail.com) */
(function($){// {{{
 
var origOuterWidth = $.fn.outerWidth, origOuterHeight = $.fn.outerHeight;
...
(function($) {
    ...
    // $.fillForm - auto fill form fields with json dataset.
    ...
    // fix native serializeArray does not serialize unchecked checkboxes.
    // enabled unchecked checkboxes by `options.checkboxesAsBools` values true;
    $.serializeArray = function(selector, options) {
        var o = $.extend({checkboxesAsBools: false}, options || {});
        var rselectTextarea = /select|textarea/i;
        var rinput = /text|hidden|password|search/i;
        var checkboxesAsBools = o.checkboxesAsBools;
        ...
        .filter(function () {
            return this.name && !this.disabled &&
                (this.checked
                || (checkboxesAsBools && this.type === 'checkbox')
        ...
        .map(function (i, elem) {
            ...
            return val == null ? null : $.isArray(val) ?
                $.map(val, function (val, i) {
                    ...
                    name: elem.name,
                    value: (checkboxesAsBools && this.type === 'checkbox') ? (this.checked ? '1' : '0') : val
                };
        }).get();
    };
